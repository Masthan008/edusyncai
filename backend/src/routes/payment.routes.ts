...
import { getFeeStructures, createFeeStructure, updateFeeStructure, recordPayment, getStudentPayments, getAccountantSummary, getPaymentReceipt } from '../controllers/payment.controller.js';
...
paymentRouter.get('/receipt/:paymentId', authenticateToken, getPaymentReceipt);
