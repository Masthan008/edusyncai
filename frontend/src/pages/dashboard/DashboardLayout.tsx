...
export default function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900 flex flex-col font-sans relative overflow-hidden">
      ...
      {/* Top Navbar Header */}
      <header className="h-16 glass-panel flex items-center justify-between px-6 sticky top-0 z-40 relative shadow-sm border-b border-white/80">
      ...
      <div className="flex flex-1 relative">
        ...
        <aside aria-label="Main navigation" className={`w-64 glass-panel border-r border-white/80 p-6 space-y-8 flex flex-col justify-between transition-all shrink-0 z-30
          fixed md:sticky top-16 bottom-0 left-0 md:h-[calc(100vh-64px)] shadow-md
